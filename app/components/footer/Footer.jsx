        ...
        <div className="container">
            <div className="row py-28">
                <div className="col-12 md:col-3 mb-5">
                    <div className="flex flex-col items-start gap-8">
                        ...
                        <p>Lorem ipsum dolor sit amet. Et debitis itaque in suscipit dicta est.</p>
                        <div className="flex items-center justify-end gap-6">
                            <span>
                                <a href="#" target="_blank">
                                    <FontAwesomeIcon icon={faFacebook} className="text-lime-500 size-6" />
                                </a>
                            </span>
                            <span>
                                <a href="#" target="_blank">
                                    <FontAwesomeIcon icon={faGoogle} className="text-lime-500 size-6" />
                                </a>
                            </span>
                            <span>
                                <a href="#" target="_blank">
                                    <FontAwesomeIcon icon={faTwitter} className="text-lime-500 size-6" />
                                </a>
                            </span>
                        </div>
                    </div>
                ...
                <div className="col-12 md:col-5 mb-5">
                    <h4 className="text-2xl font-semibold text-white mb-5">কোর্স সমূহ</h4>
                ...
                <div className="col-12 md:col-3 mb-5">
                    ...
                    <div className="flex flex-col items-start gap-4">
                        <div className="flex items-start self-stretch gap-4">
                            <span className="mt-1">
                                <FontAwesomeIcon icon={faPhoneVolume} className="text-lime-500 size-5" />
                            </span>
                        ...
                        <div className="flex items-start self-stretch gap-4">
                            <span className="mt-1">
                                <FontAwesomeIcon icon={faEnvelope} className="text-lime-500 size-5" />
                            </span>
                            <div className="flex flex-col items-start">
                        ...
                        <div className="flex items-start self-stretch gap-4">
                            <span className="mt-1">
                                <FontAwesomeIcon icon={faLocationDot} className="text-lime-500 size-5" />
                            </span>
                            <div className="flex flex-col items-start">
            ...
            <div className="row py-8 border-t border-slate-900">
                <div className="col-12 md:col-6">
                    <p className="text-sm text-center md:text-left">Copyright © 2024 Al-Madina IT Institute. All right reserved | Developed By: ZamZam Graphics</p>
                </div>
                <div className="col-12 md:col-6 flex items-center justify-center md:justify-end gap-2 md:gap-5 text-sm">
                    <span><a href="#">Publisher Terms</a></span>

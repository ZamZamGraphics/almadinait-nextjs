                    ...
                    <div className="col-12 sm:col-6">
                        <div className="flex flex-col items-start mb-8 py-10 px-8 gap-8 rounded-2xl bg-white shadow-md">
                            ...
                            <div>
                                ...
                                <p>স্কিল বৃদ্ধি থেকে শুরু করে ক্যারিয়ার ডেভেলপমেন্ট নিজেকে মানসম্পন্ন করে তোলার এ-টু-জেড সিলেবাস</p>
                            </div>
                        </div>
                        <div className="flex flex-col items-start mb-8 py-10 px-8 gap-8 rounded-2xl bg-white shadow-md">
                            <div className="size-14 flex flex-shrink-0 rounded-xl text-lime-500 bg-[#F2FAEB] items-center justify-center text-3xl">
                            ...
                            <div>
                                ...
                                <p>দক্ষ প্রশিক্ষকগণ সবচেয়ে সহজ উপায়ে কোর্স মডিউল তৈরি ও লেকচার শীট প্রদান</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 sm:col-6 self-center">
                        <div className="flex flex-col items-start mb-8 py-10 px-8 gap-8 rounded-2xl bg-white shadow-md">
                            ...
                            <div>
                                ...
                                <p>মেধা যাচাইয়ের জন্য কুইজ ও এক্সামের ব্যবস্থা কোর্স শেষে সনদ প্রদান। এবং লাইফ টাইম মেম্বারশীপ</p>
                            </div>
                        </div>
                    </div>
                </div>

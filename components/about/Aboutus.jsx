      ...
      <div className="row">
        ...
        <div className="col-12 lg:col-7 xl:col-5 mb-6 inline-flex flex-col items-start gap-12">
          <div className="inline-flex flex-col items-start">
            <h2 className="mb-6 text-2xl md:text-4xl text-gray-900 font-bold leading-snug">
            ...
            <div className="flex flex-col self-stretch items-start gap-4">
              <p>
                ...
                যাচ্ছে। প্রতিষ্ঠার পর থেকে, সুদীর্ঘ ১৫ বছর ধরে সমৃদ্ধ বাংলাদেশ
          ...
          <div className="flex flex-col items-start gap-6">
            <h3 className="text-2xl md:text-4xl text-gray-900 font-bold">
              সফলতার <span className="text-lime-500">১৫ বছর</span>
            </h3>
            <div className="row">
              <div className="col mb-6">
                <div className="flex p-6 flex-col items-start gap-4 rounded-2xl bg-white shadow-md">
                  ...
                  <div>
                    <p className="text-3xl text-lime-500 font-bold">১৩৫০০+</p>
              ...
              <div className="col mb-6">
                <div className="flex p-6 flex-col items-start gap-4 rounded-2xl bg-white shadow-md">
                  ...
                  <div>
                    <p className="text-3xl text-lime-500 font-bold">৫০০০+</p>
              ...
              <div className="col mb-6">
                <div className="flex p-6 flex-col items-start gap-4 rounded-2xl bg-white shadow-md">
                  ...
                  <div>
                    <p className="text-3xl text-lime-500 font-bold">১৮+</p>
